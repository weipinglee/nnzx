...
<div class="bloc">
   ...
   <div class="pd-20">
  <form action="{url:system/kefu/kefuAdd}" method="post" class="form form-horizontal" id="form-admin-add" auto_submit redirect_url="{url:system/kefu/kefuList}">
    ...
    <div class="row cl">
      <div class="col-9 col-offset-3">
        ...
        &emsp;<a class="btn btn-primary radius" href="{url:system/Kefu/kefuList}">&nbsp;&nbsp;返回&nbsp;&nbsp;</a>
      </div>
    </div>
  </form>
</div>
