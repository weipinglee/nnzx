	...
	<div class="main_left">
		<div class="new_list quotation_margin_top">
			...
			<ul class="content_title_ul">
				<li>
					<a class="title_a {if:$id==0}on{/if}" href="{url:/Hangye/index}/type/{$type}">全部
						<div class="c-tip-arrow" style="left: 38px;"><em></em></div>
					</a>
				</li>
				{foreach:items=$cates}
				<li>
					<a class="title_a {if:$id==$item['id']}on{/if}" href="{url:/Hangye/index}/type/{$type}/id/{$item['id']}">{$item['name']}
						<div class="c-tip-arrow" style="left: 38px;"><em></em></div>
					</a>
				</li>
				{/foreach}
