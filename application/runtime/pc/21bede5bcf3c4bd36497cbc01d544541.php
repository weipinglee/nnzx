		...
		<div class="data_box quotation_top">
			<ul class="data_list addpic">
				<li class="title">
					...
					<a href="http://info.nainaiwang.com//more/index/type/<?php echo isset($data[0][0]['type'])?$data[0][0]['type']:"";?>"><span>更多</span></a>
				</li>
		...
		<div class="data_box">
			<ul class="data_list addpic">
				<li class="title">
					...
					<a href="http://info.nainaiwang.com//more/index/type/<?php echo isset($data[1][0]['type'])?$data[1][0]['type']:"";?>"><span>更多</span></a>
				</li>
