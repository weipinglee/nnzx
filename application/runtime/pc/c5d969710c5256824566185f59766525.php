	...
	<div class="main_left">
		<div class="new_list quotation_margin_top">
			...
			<ul class="content_title_ul">
				<li>
					<a class="title_a <?php if($id==0){?>on<?php }?>" href="http://localhost/nnzx//more/index/type/<?php echo isset($type_id)?$type_id:"";?>">全部
						<div class="c-tip-arrow" style="left: 38px;"><em></em></div>
					</a>
				</li>
				<?php if(!empty($cates)) foreach($cates as $key => $item){?>
				<li>
					<a class="title_a <?php if($id==$item['id']){?>on<?php }?>" href="http://localhost/nnzx//more/index/type/<?php echo isset($type_id)?$type_id:"";?>/id/<?php echo isset($item['id'])?$item['id']:"";?>"><?php echo isset($item['name'])?$item['name']:"";?>
						<div class="c-tip-arrow" style="left: 38px;"><em></em></div>
					</a>
				</li>
				<?php }?>
				...
				<div class="news">
					<?php if(isset($item['cover'][0])){?>
						...
						<div class="news_content">
							<h3>
								<a href="http://localhost/nnzx//more/index/type/<?php echo isset($item['type'])?$item['type']:"";?>/id/<?php echo isset($item['cate_id'])?$item['cate_id']:"";?>"><span class="trade"><?php echo isset($item['cate_name'])?$item['cate_name']:"";?></span></a>
