		...
		<?php if(!empty($type)) foreach($type as $key => $item){?>
			<div class="data_list">
				...
				<div class="data_content">
					<div class="hot_news">
						<a href="http://localhost/nnzx//detail/index/id/<?php echo isset($data[$item['id']][0][0]['id'])?$data[$item['id']][0][0]['id']:"";?>"><img src="<?php echo isset($data[$item['id']][0][0]['cover'][0])?$data[$item['id']][0][0]['cover'][0]:"";?>"></a>
						<div class="hot_point">
					...
					<ul>
						...
						<li>
							<a href="http://localhost/nnzx//detail/index/id/<?php echo isset($data[$item['id']][0][1]['id'])?$data[$item['id']][0][1]['id']:"";?>"><img src="<?php echo isset($data[$item['id']][0][1]['cover'][0])?$data[$item['id']][0][1]['cover'][0]:"";?>" title="<?php echo isset($data[$item['id']][0][1]['name'])?$data[$item['id']][0][1]['name']:"";?>" class="list_hot"></a>
