		...
		<?php if(!empty($type)) foreach($type as $key => $item){?>
			<div class="data_list">
				<div class="data_title">
					...
					<a href="http://localhost/nnzx//more/index/type/<?php echo isset($data[$item['id']][0][0]['type'])?$data[$item['id']][0][0]['type']:"";?>"><span>更多</span></a>
				</div>
				<div class="data_content">
					<div class="hot_news">
						<a href="http://localhost/nnzx//detail/index/id/<?php echo isset($data[$item['id']][0][0]['id'])?$data[$item['id']][0][0]['id']:"";?>"><img src="<?php echo isset($data[$item['id']][0][0]['cover_pic'])?$data[$item['id']][0][0]['cover_pic']:"";?>"></a>
						<div class="hot_point">
							<a href="http://localhost/nnzx//detail/index/id/<?php echo isset($data[$item['id']][0][0]['id'])?$data[$item['id']][0][0]['id']:"";?>"><?php echo isset($data[$item['id']][0][0]['name'])?$data[$item['id']][0][0]['name']:"";?></a>
						</div>
					</div>
					<ul>
						<?php if(isset($data[$item['id']][0][1]['id'])){?>
						<li>
							<a href="http://localhost/nnzx//detail/index/id/<?php echo isset($data[$item['id']][0][1]['id'])?$data[$item['id']][0][1]['id']:"";?>"><img src="<?php echo isset($data[$item['id']][0][1]['cover_pic'])?$data[$item['id']][0][1]['cover_pic']:"";?>" title="<?php echo isset($data[$item['id']][0][1]['name'])?$data[$item['id']][0][1]['name']:"";?>" class="list_hot"></a>
							<span class="list_hot_cont">
								<!-- 此处需要控制字数 -->
								<p><a href="http://localhost/nnzx//detail/index/id/<?php echo isset($data[$item['id']][0][1]['id'])?$data[$item['id']][0][1]['id']:"";?>"><?php echo isset($data[$item['id']][0][1]['name'])?$data[$item['id']][0][1]['name']:"";?></a></p>
								<p><a href="http://localhost/nnzx//detail/index/id/<?php echo isset($data[$item['id']][0][1]['id'])?$data[$item['id']][0][1]['id']:"";?>"><?php echo isset($data[$item['id']][0][1]['short_content'])?$data[$item['id']][0][1]['short_content']:"";?></a></p>
							</span>
						</li>
						<?php }?>
		...
		<div class="data_box">
			<ul class="data_list">
				<li class="title">
					...
					<a href="http://localhost/nnzx//more/index/type/4"><span>更多</span></a>
				</li>
